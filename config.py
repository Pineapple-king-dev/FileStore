...
FORCE_SUB_CHANNEL_3 = int(os.environ.get("FORCE_SUB_CHANNEL_3", "-1002360152411"))
FORCE_SUB_CHANNEL_4 = int(os.environ.get("FORCE_SUB_CHANNEL_4", "-1002342377222"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "1214348787 5743248220 1993048420").split()):
        ADMINS.append(int(x))
except ValueError:
